...
1. Create directory: Bash(command="mkdir -p <cc10x-memory-dir>")
...
6. **Update memory** - Use Edit tool (permission-free) to update cc10x memory files in active memory directory
