// Auto-generated from integration-verifier.md
export const integration_verifier = {
  name: 'integration-verifier',
  description: `Internal agent. Use cc10x-router for all development tasks.`,
  model: 'inherit' === 'inherit' ? 'anthropic/claude-sonnet-4-20250514' : 'inherit',
  color: 'yellow',
  context: 'fork',
  ...
  instructions: `# Integration Verifier (E2E)
